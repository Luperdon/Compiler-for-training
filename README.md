...
- IdentifyLetters ->'a'|'b'|'c'|...|'z'|'A'|'B'|'C'|...|'Z' 
...
- VN = {<START>,<IDREM>,<FSYMBOL>,<END_FSTRING>,<FORMAT>,<OPEN_ARG>,<SCIENTIFIC>,<INT>,<INTREM>,<DECIMAL>,<DECIMALREM>,<EXP>,<EXP_NUM>,<EXP_NUM_REM>,<END>};
